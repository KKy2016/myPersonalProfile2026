...
*/ var ScrollReveal = function() {
    ...
    function m(e) {
        ...
        if (parseFloat(i.distance)) {
            var T = "top" === i.origin || "bottom" === i.origin ? "Y" : "X", O = i.distance;
            "top" !== i.origin && "left" !== i.origin || (O = /^-/.test(O) ? O.substr(1) : "-" + O);
            var k = O.match(/(^-?\d+\.?\d?)|(em$|px$|%$)/g), x = k[0];
            switch(k[1]){
                case "em":
        ...
        if (E.generated || A.generated.initial) {
            ...
            var P = i.delay, I = i.duration, L = i.easing;
...
//# sourceMappingURL=myPersonalProfile2026.6c5a5ebc.js.map
