/*!
 * github-buttons v2.33.0
 * (c) 2026 なつき
 * @license BSD-2-Clause
 */ !function() {
    "use strict";
    var e = window.document, o = e.location, t = window.Math, r = window.HTMLElement, a = window.XMLHttpRequest, n = "github-button", i = "https://buttons.github.io/buttons.html", c = "github.com", l = "https://api." + c, d = a && "prototype" in a && "withCredentials" in a.prototype, s = d && r && "attachShadow" in r.prototype && !("prototype" in r.prototype.attachShadow), u = function(e, o) {
        ...
        var r = f(e.ownerDocument), a = e.appendChild(r("style", {
            type: "text/css"
        ...
        var i = "large" === b(o["data-size"]), d = r("a", {
            className: "btn",
            href: o.href,
            rel: "noopener",
            target: "_blank",
            ...
            innerHTML: F(o["data-icon"], i ? 16 : 14) + "&nbsp;"
        }, [
            r("span", {}, [
                o["data-text"] || ""
            ])
    ...
    }, L = window.devicePixelRatio || 1, _ = function(e) {
        ...
        if (null != o && null != r) {
            if (o.getAttribute && (o = function(e) {
                ...
                G(n, [
                    0,
                    0
                ]), n.style.border = "none", n.style.colorScheme = "light";
                var c = function() {
...
//# sourceMappingURL=myPersonalProfile2026.faeb358e.js.map
